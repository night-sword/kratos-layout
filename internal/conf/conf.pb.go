...
type Data struct {
	...
	Registrar *Data_Registrar `protobuf:"bytes,3,opt,name=registrar,proto3" json:"registrar,omitempty"`
	DemoGrpc  *Data_DemoGrpc  `protobuf:"bytes,4,opt,name=demoGrpc,proto3" json:"demoGrpc,omitempty"`
}
...
func (x *Data) GetDemoGrpc() *Data_DemoGrpc {
	if x != nil {
		return x.DemoGrpc
	}
	return nil
...
type Job struct {
	...
	Jobs          map[string]*Job_JobOption `protobuf:"bytes,1,rep,name=jobs,proto3" json:"jobs,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
	DefaultConfig *Job_JobOption            `protobuf:"bytes,2,opt,name=defaultConfig,proto3" json:"defaultConfig,omitempty"`
}
...
func (x *Job) GetJobs() map[string]*Job_JobOption {
	if x != nil {
		return x.Jobs
	}
	return nil
...
func (x *Job) GetDefaultConfig() *Job_JobOption {
	if x != nil {
...
func (x *Data_DemoGrpc) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*Data_DemoGrpc) ProtoMessage() {}

func (x *Data_DemoGrpc) ProtoReflect() protoreflect.Message {
	mi := &file_conf_conf_proto_msgTypes[10]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use Data_DemoGrpc.ProtoReflect.Descriptor instead.
func (*Data_DemoGrpc) Descriptor() ([]byte, []int) {
	return file_conf_conf_proto_rawDescGZIP(), []int{2, 3}
}

func (x *Data_DemoGrpc) GetName() string {
	if x != nil {
		return x.Name
	}
	return ""
...
func (x *Data_DemoGrpc) GetAddr() string {
	if x != nil {
		return x.Addr
	}
	return ""
...
type Job_JobOption struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	MaxRetry    int32                `protobuf:"varint,1,opt,name=maxRetry,proto3" json:"maxRetry,omitempty"`       // 设置最大重试次数
	Timeout     *durationpb.Duration `protobuf:"bytes,2,opt,name=Timeout,proto3" json:"Timeout,omitempty"`          // 超时时间
	Concurrency int32                `protobuf:"varint,3,opt,name=concurrency,proto3" json:"concurrency,omitempty"` // 该任务并发度
	RetryDelay  *durationpb.Duration `protobuf:"bytes,4,opt,name=retryDelay,proto3" json:"retryDelay,omitempty"`    // 休息多长时候后重试
	Retention   *durationpb.Duration `protobuf:"bytes,5,opt,name=retention,proto3" json:"retention,omitempty"`      // 任务保留时间
}

func (x *Job_JobOption) Reset() {
	*x = Job_JobOption{}
	if protoimpl.UnsafeEnabled {
...
func (x *Job_JobOption) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*Job_JobOption) ProtoMessage() {}

func (x *Job_JobOption) ProtoReflect() protoreflect.Message {
	mi := &file_conf_conf_proto_msgTypes[11]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use Job_JobOption.ProtoReflect.Descriptor instead.
func (*Job_JobOption) Descriptor() ([]byte, []int) {
	return file_conf_conf_proto_rawDescGZIP(), []int{3, 0}
}

func (x *Job_JobOption) GetMaxRetry() int32 {
	if x != nil {
		return x.MaxRetry
	}
	return 0
...
func (x *Job_JobOption) GetTimeout() *durationpb.Duration {
	if x != nil {
		return x.Timeout
	}
	return nil
...
func (x *Job_JobOption) GetConcurrency() int32 {
	if x != nil {
...
func (x *Job_JobOption) GetRetryDelay() *durationpb.Duration {
	if x != nil {
		return x.RetryDelay
	}
	return nil
...
func (x *Job_JobOption) GetRetention() *durationpb.Duration {
	if x != nil {
		return x.Retention
	}
	return nil
...
var file_conf_conf_proto_rawDesc = []byte{
	...
	0x21, 0x0a, 0x03, 0x6a, 0x6f, 0x62, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x0f, 0x2e, 0x6b,
	0x72, 0x61, 0x74, 0x6f, 0x73, 0x2e, 0x61, 0x70, 0x69, 0x2e, 0x4a, 0x6f, 0x62, 0x52, 0x03, 0x6a,
	0x6f, 0x62, 0x22, 0xb8, 0x02, 0x0a, 0x06, 0x53, 0x65, 0x72, 0x76, 0x65, 0x72, 0x12, 0x2b, 0x0a,
	...
	0x74, 0x69, 0x6f, 0x6e, 0x52, 0x07, 0x74, 0x69, 0x6d, 0x65, 0x6f, 0x75, 0x74, 0x22, 0xbf, 0x04,
	...
	,
	...
	0x52, 0x06, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x1a, 0xc5, 0x01, 0x0a, 0x05, 0x52, 0x65, 0x64,
	...
	0x77, 0x64, 0x12, 0x3c, 0x0a, 0x0c, 0x72, 0x65, 0x61, 0x64, 0x5f, 0x74, 0x69, 0x6d, 0x65, 0x6f,
	...
	0x1a, 0x29, 0x0a, 0x09, 0x52, 0x65, 0x67, 0x69, 0x73, 0x74, 0x72, 0x61, 0x72, 0x12, 0x1c, 0x0a,
	0x09, 0x65, 0x6e, 0x64, 0x70, 0x6f, 0x69, 0x6e, 0x74, 0x73, 0x18, 0x01, 0x20, 0x03, 0x28, 0x09,
	0x52, 0x09, 0x65, 0x6e, 0x64, 0x70, 0x6f, 0x69, 0x6e, 0x74, 0x73, 0x1a, 0x32, 0x0a, 0x08, 0x44,
	0x65, 0x6d, 0x6f, 0x47, 0x72, 0x70, 0x63, 0x12, 0x12, 0x0a, 0x04, 0x6e, 0x61, 0x6d, 0x65, 0x18,
	...
	,
	...
	0x61, 0x6c, 0x75, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x19, 0x2e, 0x6b, 0x72, 0x61,
	0x74, 0x6f, 0x73, 0x2e, 0x61, 0x70, 0x69, 0x2e, 0x4a, 0x6f, 0x62, 0x2e, 0x4a, 0x6f, 0x62, 0x4f,
	0x70, 0x74, 0x69, 0x6f, 0x6e, 0x52, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38, 0x01,
	0x22, 0x0a, 0x0a, 0x08, 0x42, 0x75, 0x73, 0x69, 0x6e, 0x65, 0x73, 0x73, 0x42, 0x37, 0x5a, 0x35,
...
var file_conf_conf_proto_goTypes = []interface{}{
	...
	(*Data_Registrar)(nil),      // 9: kratos.api.Data.Registrar
	(*Data_DemoGrpc)(nil),       // 10: kratos.api.Data.DemoGrpc
	(*Job_JobOption)(nil),       // 11: kratos.api.Job.JobOption
	nil,                         // 12: kratos.api.Job.JobsEntry
	(*durationpb.Duration)(nil), // 13: google.protobuf.Duration
}
var file_conf_conf_proto_depIdxs = []int32{
	1,  // 0: kratos.api.Bootstrap.server:type_name -> kratos.api.Server
	2,  // 1: kratos.api.Bootstrap.data:type_name -> kratos.api.Data
	4,  // 2: kratos.api.Bootstrap.business:type_name -> kratos.api.Business
	3,  // 3: kratos.api.Bootstrap.job:type_name -> kratos.api.Job
	...
	9,  // 8: kratos.api.Data.registrar:type_name -> kratos.api.Data.Registrar
	10, // 9: kratos.api.Data.demoGrpc:type_name -> kratos.api.Data.DemoGrpc
	12, // 10: kratos.api.Job.jobs:type_name -> kratos.api.Job.JobsEntry
	11, // 11: kratos.api.Job.defaultConfig:type_name -> kratos.api.Job.JobOption
	...
	13, // 16: kratos.api.Job.JobOption.Timeout:type_name -> google.protobuf.Duration
	13, // 17: kratos.api.Job.JobOption.retryDelay:type_name -> google.protobuf.Duration
	13, // 18: kratos.api.Job.JobOption.retention:type_name -> google.protobuf.Duration
	11, // 19: kratos.api.Job.JobsEntry.value:type_name -> kratos.api.Job.JobOption
