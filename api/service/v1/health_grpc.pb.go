...
const (
	Health_HealthCheck_FullMethodName = "/api.service.v1.Health/HealthCheck"
)
...
func (c *healthClient) HealthCheck(ctx context.Context, in *HealthRequest, opts ...grpc.CallOption) (*HealthReply, error) {
	out := new(HealthReply)
...
func (UnimplementedHealthServer) HealthCheck(context.Context, *HealthRequest) (*HealthReply, error) {
...
var Health_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "api.service.v1.Health",
	...
	Metadata: "service/v1/health.proto",
}
