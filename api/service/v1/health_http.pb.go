...
const OperationHealthHealthCheck = "/api.service.v1.Health/HealthCheck"
...
func (c *HealthHTTPClientImpl) HealthCheck(ctx context.Context, in *HealthRequest, opts ...http.CallOption) (*HealthReply, error) {
	var out HealthReply
	pattern := "/health"
